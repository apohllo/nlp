...
3. Configure one document store based on ElasticSearch and another document store based on Faiss supported by DPR:
   ...
   2. For DPR you should use [Polish question](https://huggingface.co/enelpol/czywiesz-question) and 
      [Polish context](https://huggingface.co/enelpol/czywiesz-context) encoders.
